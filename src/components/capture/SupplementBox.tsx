...
export function SupplementBox() {
  ...
  return (
    <main className="min-h-screen bg-slate-950/85 p-4 text-slate-100">
      <section className="flex h-full flex-col rounded-3xl border border-white/10 bg-slate-950/95 p-4 shadow-2xl shadow-black/50 backdrop-blur-xl">
        ...
        <div className="mt-4 grid flex-1 gap-4 md:grid-cols-[180px_minmax(0,1fr)]">
          {/* Screenshot preview */}
          <div className="flex min-h-[180px] items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-slate-900/70">
            {screenshotPreviewUrl ? (
              <img
          ...
          <div className="flex flex-col gap-3">
            <textarea
              ...
              className="min-h-[180px] resize-none rounded-2xl border border-white/10 bg-slate-900/80 px-4 py-3 text-sm leading-6 text-slate-100 outline-none transition focus:border-sky-400/40 focus:ring-2 focus:ring-sky-400/20"
            />
